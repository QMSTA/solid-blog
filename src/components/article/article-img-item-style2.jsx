    ...
    return (
        <>
            <article class="mb-8">
                ...
                <div class="h-[200px] mt-4 flex flex-row items-center">
                    ...
                    <div class="flex-1 h-full py-2 flex flex-col">
                        <div class="flex-1 py-2 text-gray-500 overflow-hidden">
                            <p>#这是一段测试文本这是一段测试文本这是一段测试文本这是一</p>
                            <p>这是一段测试文本这是一段测试文本这</p>
                            <p>这是一段测试文本这是一段测试文本这是一段测试文本这是一段测试文本</p>
                            <p>#这是一段测试文本这是一段测试文本这是一段测试文本这是一段测试文本</p>
                        </div>
                        <div class="transition flex flex-row mt-4 justify-end text-gray-600">
